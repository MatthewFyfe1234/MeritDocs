export function ConceptSlide() {
  return (
    <div className="w-full h-full p-8 flex flex-col relative">
      ...
      {/* Callout — absolutely positioned top-right, out of flow */}
      <div
      ...
      >
        <p className="text-xs font-semibold mb-1" style={{ color: 'var(--slide-primary)' }}>
          Holistic and unbounded
        </p>
        <p className="text-xs leading-relaxed" style={{ color: 'var(--slide-text)', opacity: 0.75 }}>
          Span your internal delivery ecosystem, or your entire B2B network.
        </p>
      </div>

      {/* Callout — absolutely positioned bottom-right, out of flow */}
      <div
        className="absolute rounded-lg p-3"
      ...
      {/* Diagram — full width, content centred */}
      <div className="flex-1 min-h-0 flex items-start justify-center">
        <svg viewBox="0 0 660 280" style={{ width: '100%' }}>
          ...
          {/* ── ORTHOGONAL CONNECTORS — right, vertical, right with rounded corners ── */}
          {/* Agents → Process: goes right, down, right */}
          ...
          {/* Inventory → Process: goes right, up, right */}
