...
export function ProblemSlide() {
  const rows: {
  ...
  }[] = [
    {
      ...
      quote:      'The most important figures that one needs for management are unknown or unknowable, but successful management must nevertheless take account of them.',
      quoteRefs:  [11],
      stat:       '3×',
    ...
    },
    {
      ...
      quote:      "Green doesn't mean healthy. It means 'no one wants to say otherwise.'",
      quoteRefs:  [12],
      stat:       '4×',
    ...
    },
    {
      ...
      quote:      'It borders on dereliction that organizations invest so few resources in studying what has succeeded and failed in past strategies, operational changes, and leadership approaches.',
      quoteRefs:  [13],
      stat:       '3–4 hrs',
    ...
    },
    {
      ...
      quote:      'Managers and staff alike too often view performance management as time consuming, excessively subjective, demotivating, and ultimately unhelpful.',
      quoteRefs:  [10],
      stat:       '75%',
