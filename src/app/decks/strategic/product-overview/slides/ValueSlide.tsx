...
export function ValueSlide() {
  const columns = [
    ...
    },
    {
      ...
      accent: false,
      points: [
        'The model learns from every execution',
        'Planning quality improves automatically',
        'Selection sharpens as the dataset grows',
        'Management structures thin as the model takes on coordination and reporting',
      ],
    ...
    },
    {
      ...
      accent: true,
      points: [
        'A proprietary dataset no competitor can replicate',
        'The longer it runs, the wider the gap',
        'Organisational intelligence that outlasts any individual',
      ],
  ...
  return (
    <SlideLayout
      ...
      subtitle="Every execution makes the model smarter. Every project widens the gap."
    >
