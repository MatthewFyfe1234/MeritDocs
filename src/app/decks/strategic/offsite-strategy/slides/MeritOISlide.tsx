...
export function MeritOISlide() {
  return (
    <SlideLayout
      ...
      subtitle="One system across the whole workflow: process mapping, business intelligence, and organisational memory built for the project-based manufacturer"
    >
