...
export function ContinuousImprovementSlide() {
  return (
    <SlideLayout
      title="The Organisation That Gets Smarter"
      subtitle="Other tools store your data. Merit OI turns it into open-box intelligence built and owned by your ever-evolving team."
    >
