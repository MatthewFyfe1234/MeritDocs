...
export function CommonSystemsSlide() {
  return (
    <SlideLayout
      title="Offsite Systems: Scope Finding"
      subtitle="Nine structural system types across building and infrastructure applications, forming the initial product scope"
    >
      ...
      <div className="flex-1 min-h-0 flex gap-3">
        ...
        <div className="shrink-0 flex flex-col gap-2.5" style={{ width: '11rem' }}>
          {categories.map((cat) => (
            <div
              key={cat.name}
