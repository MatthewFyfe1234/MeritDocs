...
export function DigitalGapSlide() {
  return (
    <SlideLayout
      title="Merit Operational Intelligence"
      subtitle="Built to close the digital gap in offsite construction"
    >
      {/* Two-column body */}
      <div className="flex-1 min-h-0 grid grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-3 min-h-0">
          <div className="flex items-center gap-2">
            <span className="text-sm font-semibold" style={{ color: '#6b7a85' }}>The Status Quo</span>
            <span className="rounded-full px-2 py-0.5 text-xs font-semibold shrink-0" style={{ backgroundColor: '#fff7ed', color: '#c2410c', border: '1px solid #fed7aa' }}>
              2nd lowest digital adoption (McKinsey)<sup>13</sup>
            </span>
          </div>
        ...
        <div className="flex flex-col gap-3 min-h-0">
          <div className="flex items-center gap-2">
            <span className="text-sm font-semibold" style={{ color: 'var(--slide-primary)' }}>Merit OI</span>
