...
export function OffsiteConstructionSlide() {
  return (
    <SlideLayout
      title="Offsite Construction at a Glance"
      subtitle="Factory-manufactured components assembled on site, blending manufacturing precision with construction flexibility"
    >
      {/* Content Grid */}
