...
export function CompetitorSlide() {
  return (
    <SlideLayout
      title="Why No Existing Tool Covers This"
      subtitle="Each competitor is a vertical slice: designed for one function, one context, one phase. None orchestrate across the full delivery lifecycle. None carry the organisational memory that turns completed projects into competitive advantage."
    >
      {/* Table */}
      ...
      <div className="shrink-0 mt-3 flex items-center gap-4">
        ...
        >
          <p className="text-xs font-medium" style={{ color: 'var(--slide-primary)' }}>
            ...
            Every competitor here is a tool: built for one function, context or phase. At the organisational level Merit OI is a Business OS. The delivery pipeline shown above is one dimension. HR, operations, and inventory run on the same shared process network, so every function learns from the same organisational memory.
          </p>
        </div>
