  ...
  const cards = [
    {
      ...
      body:    'Operators with a Merit execution record present granular, tamper-proof operational data at renewal. Insurers who can see how equipment was actually used price it accordingly. The record is the leverage.',
      col:     0,
    },
    {
      label:   'Litigation',
    ...
    },
    {
      ...
      ref:     5 as number | null,
      body:    'Each operational step is recorded as it happens. Compliance is embedded in the process, not reconstructed afterwards. Auditors and FOI requests see a complete, timestamped record of what was done and when.',
      col:     0,
    },
    {
      label:   'Safety',
      icon:    'Enforced',
      iconSub: 'correct sequencing as a structural property, not an instruction',
      ref:     null as number | null,
      body:    'An operational step cannot be skipped without the deviation being recorded. The correct procedure is enforced by the process, not by individual discipline. When something fails, the record shows exactly what preceded it.',
      col:     1,
    },
  ];
