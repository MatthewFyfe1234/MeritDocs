    ...
    <SlideLayout title="What Merit OI Delivers">
      ...
      >
        <p className="text-base font-medium leading-relaxed" style={{ color: 'var(--slide-primary)' }}>
          Merit OI gives timber frame, CLT, and truss manufacturers one connected operational model: orchestrating across your specialist design tools to generate deterministic cost and delivery forecasts at the point of spec, closing the loop between what was designed and what was built, and turning every completed project into sharper estimates, more reliable commitments, and institutional knowledge that compounds.
        </p>
      </div>
