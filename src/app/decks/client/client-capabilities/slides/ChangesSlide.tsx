...
export function ChangesSlide() {
  const changes = [
    ...
    },
    {
      ...
      after:  'Modelled as a deterministic network. Forecasts, not estimates.',
      how:    'The process model, trained on execution data, generates forecasts rather than estimates.',
    },
    {
  ...
  return (
    <SlideLayout title="What Changes">
