...
const cards = [
  {
    label:   'Insurance',
    icon:    '10-30%',
    iconSub: 'E&O premium discount available with verified installation records',
    ref:     4 as number | null,
    body:    'Without a verified record of correct use, underwriters cannot distinguish between design risk and execution risk. With one, they can. Vendors with a closed-loop record per job presented lower exposure at renewal.',
    col:     0,
  },
  {
    label:   'Warranty Defense',
    icon:    '$250K',
    iconSub: 'first-year defense and expert fees per party, before any settlement',
    ref:     1 as number | null,
    body:    'When a structural claim arrives, the record answers who did what, in what order. The specification was correct. The execution record shows whether it was followed. Liability is attributable before depositions begin.',
    col:     1,
  },
  {
    label:   'Compliance',
  ...
  },
  {
    ...
    icon:    '96%',
    iconSub: 'of construction data generated on projects never analysed or returned',
    ref:     3 as number | null,
    body:    'Every job run against your specification feeds back a deviation profile: what matched, what was substituted, what failed. Design assumptions are corrected before the next version ships with the same error.',
    col:     1,
  },
];
