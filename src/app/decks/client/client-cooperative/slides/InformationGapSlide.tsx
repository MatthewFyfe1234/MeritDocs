    ...
    <SlideLayout>
      ...
      <div className="flex-1 min-h-0 flex flex-col justify-center gap-6 px-4">
        ...
        <p className="text-sm leading-relaxed max-w-2xl" style={{ color: 'var(--slide-text)', opacity: 0.6 }}>
          When every stage, every contribution, and every material is recorded against the project model, surplus is divided by what was actually delivered. Governance decisions are grounded in evidence, not advocacy. The member who does the work and the member who votes on it are looking at the same record. Democratic principles stop being aspirational and start being operational.
        </p>
      </div>
