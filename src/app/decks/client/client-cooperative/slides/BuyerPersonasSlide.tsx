...
const personas = [
  {
    ...
    complaints: [
      ...
      { text: 'The reverse dominance hierarchy that emerges weakens leadership while preserving its costs: decisions are slow, unpopular changes are blocked, and accountability remains diffuse', refs: [1] },
      { text: 'Only 19.1% of members participate in any governance decision at scale. The MD inherits a democratic mandate that most members have already stopped exercising', refs: [2] },
    ] as Complaint[],
  ...
  },
  {
    ...
    complaints: [
      { text: 'The horizon problem means members systematically underinvest in projects with long payoffs. Surplus distribution disputes accelerate this, compounding the capital constraint', refs: [5] },
      { text: 'When the link between contribution and reward becomes opaque, disengagement follows. Free-riding increases, effort declines, and the cooperative\'s founding logic inverts in practice', refs: [6] },
      { text: 'When contribution visibility is low, free-riding increases and seniority fills the gap. The cooperative\'s principles invert in practice', refs: [6] },
    ] as Complaint[],
  ...
  },
  {
    ...
    companySize: '30–300 members',
    day: "I can ask people to do things. I can't tell them. In a conventional firm that distinction doesn't matter much. On a live site or a factory floor with a deadline, it matters enormously.",
    dayRefs: [] as number[],
    tools: ['Procore', 'MS Project', 'WhatsApp', 'Excel'],
    complaints: [
      { text: 'When responsibility for execution is diffuse, free-riding increases with group size. The informal social pressure that once drove accountability is replaced by a diffusion of responsibility that no individual feels obligated to resolve', refs: [6] },
      { text: 'With 80.9% of members uninvolved in governance, operational decisions lack democratic backing. The PM enforces standards that no formal process has endorsed and no member feels bound to respect', refs: [2] },
  ...
  return (
    <SlideLayout
      ...
      headerContent={
        ...
        >
          ICP: Worker cooperative · 30–300 members
        </span>
      }
    >
