    ...
    <div className="w-full h-full p-8 flex flex-col">
      ...
      >
        <p className="text-base font-medium leading-relaxed" style={{ color: 'var(--slide-primary)' }}>
          Merit OI gives offsite structural fabricators one connected workflow that generates deterministic cost and delivery forecasts at the point of spec, replacing the fragmented tool stack that causes margin leakage and turning every completed project into sharper estimates, more reliable commitments, and an institutional advantage that compounds.
        </p>
      </div>
